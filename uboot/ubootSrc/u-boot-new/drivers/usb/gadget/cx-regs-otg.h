...
#ifndef __CX_REGS_USB_OTG_HS_H
#define __CX_REGS_USB_OTG_HS_H

#include <asm/types.h>

/* USB2.0 OTG Controller register */
struct cx_usbotg_phy {
	u32 phypwr;
	u32 phyclk;
	u32 rstcon;
};
...
struct cx_usbotg_reg {
	...
	u8  res4[224];
	struct cx_dev_in_endp in_endp[16];
	struct cx_dev_out_endp out_endp[16];
	u8  res5[768];
...
/* cx_UDC_OTG_GINTSTS/cx_UDC_OTG_GINTMSK core interrupt register */
...
/* cx_UDC_OTG_DCTL device control register */
#define NORMAL_OPERATION		(0x1<<0)
#define SOFT_DISCONNECT		(0x1<<1)

/* cx_UDC_OTG_DAINT device all endpoint interrupt register */
#define DAINT_OUT_BIT			(16)
#define DAINT_MASK			(0xFFFF)

/* cx_UDC_OTG_DIEPCTL0/DOEPCTL0 device
...
/* cx_UDC_OTG_DIEPMSK/DOEPMSK device IN/OUT endpoint
   common interrupt mask register */
/* cx_UDC_OTG_DIEPINTn/DOEPINTn device IN/OUT endpoint interrupt register */
...
#define GAHBCFG_INIT	(PTXFE_HALF | NPTXFE_HALF | MODE_DMA | BURST_INCR4\
			| GBL_INT_UNMASK)
#define GAHBCFG_INIT_MASK	(PTXFE_HALF | NPTXFE_HALF | MODE_DMA | BURST_INCR16\
			| GBL_INT_MASK)
