...
#if defined(CONFIG_CX_UDC_DMA) || defined (CONFIG_CX_UDC)
#define gadget_is_cxhsotg(g)        (!strcmp("cx-hsotg", (g)->name))
#else
#define gadget_is_cxhsotg(g)        0
#endif
...
static inline int usb_gadget_controller_number(struct usb_gadget *gadget)
{
	if (gadget_is_net2280(gadget))
		...
		return 0x22;
	else if (gadget_is_cxhsotg(gadget))
		return 0x23;
	return -ENOENT;
}
